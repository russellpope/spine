...
Completion is judged by a fresh-context check — the machine-checkable criteria plus a verifier
subagent that did not write the code — never by the generator's self-assessment.
